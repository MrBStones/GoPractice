...
Our packages are integers sent through a go channel. The structure is a go channel.
...
A real distributed system would span multiple machines and go through large networks. There might also be high network loads, where here there is a single request which terminates the program after.
